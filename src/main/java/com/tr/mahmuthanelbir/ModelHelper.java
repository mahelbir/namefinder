...
public class ModelHelper {
    public static String[] sentences(String body) {
        try (InputStream modelIn = ModelHelper.class.getResourceAsStream("/en-sent.bin")) { //read the model file from resources
            if (modelIn != null) {
    ...
    public static String[] tokens(String[] sentences) {
        ...
        try (InputStream modelIn = ModelHelper.class.getResourceAsStream("/en-token.bin")) { //read the model file from resources
            if (modelIn != null) {
    ...
    public static LinkedList<String> names(String[] tokens) {
        ...
        try (InputStream modelIn = ModelHelper.class.getResourceAsStream("/en-ner-person.bin")) { //read the model file from resources
            if (modelIn != null) {
